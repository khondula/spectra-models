...
* See [here](https://khondula.github.io/spectra-models/03-PRLA-AOP.html) for AOP spectra from PRLA buoy location
...
algae_sums_x_class %>% 
  ...
  ggtitle(glue('Rel abundance of algae by algal class'))

algae_sums_x_div %>% 
  ggplot(aes(x = collectDate, y = rel_abun)) +
  geom_bar(aes(fill = division), stat = 'identity') +
  facet_wrap(vars(algalParameter), scales = "free_y") +
  ggtitle(glue('Rel abundance of algae by algal division'))
...
algae_sums_x_type %>% 
  ggplot(aes(x = collectDate, y = sum_param)) +
  geom_bar(aes(fill = algalType), position = 'dodge', stat = 'identity') +
  facet_wrap(vars(algalParameter), scales = "free_y") +
  ggtitle(glue('Sum of algae by algal type'))
```
...
avail_list[[11]]$data1 %>%
    ...
    geom_point(pch = 21, size = 2, fill = 'green') +
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 1 day around {lubridate::as_date(avail_list[[11]]$summary$flightline_datetime)}'))

avail_list[[11]]$dataHr %>%
    dplyr::filter(chlorophyllFinalQF == 0) %>%
    ggplot(aes(x = startDateTime, y = chlorophyll)) +
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    ...
    geom_point(pch = 21, size = 2, fill = 'green') +
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 12 hours around {avail_list[[11]]$summary$flightline_datetime} UTC'))
...
avail_list[[12]]$data1 %>%
    ...
    geom_point(pch = 21, size = 2, fill = 'green') +
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 1 day around {lubridate::as_date(avail_list[[12]]$summary$flightline_datetime)}'))

avail_list[[12]]$dataHr %>%
    dplyr::filter(chlorophyllFinalQF == 0) %>%
    ggplot(aes(x = startDateTime, y = chlorophyll)) +
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    ...
    geom_point(pch = 21, size = 2, fill = 'green') +
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 12 hours around {avail_list[[12]]$summary$flightline_datetime} UTC'))
...
avail_list[[13]]$data30 %>%
  ...
  coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 30 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))

avail_list[[13]]$data10 %>%
    # dplyr::filter(chlorophyllFinalQF == 0) %>%
    ggplot(aes(x = startDateTime, y = chlorophyll)) +
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    ...
    theme_bw() +
    coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 10 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 1 day around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[16]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 1 day around {avail_list[[16]]$summary$flightline_datetime} UTC'))

avail_list[[17]]$data10 %>%
    # dplyr::filter(chlorophyllFinalQF == 0) %>%
    ggplot(aes(x = startDateTime, y = chlorophyll)) +
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    ...
    theme_bw() +
    coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 10 days around {lubridate::as_date(avail_list[[17]]$summary$flightline_datetime)}'))
...
df2019 <- match_aop_sensor(aop_datetimes_df, chl_df_ma)
...
rm1 <- chl_df_tsibble %>%
    ...
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(5), 
           avail_list[[13]]$summary$flightline_datetime + ddays(5))) +
    coord_cartesian(ylim = c(NA, 40)) +
    ggtitle(glue('Rolling mean 3 hours'))
  rm2 <- chl_df_tsibble %>%
    ggplot(aes(x = datetime, y = chl5min)) +
    ...
    geom_point(pch = 21, fill = 'green', alpha = 0.25, size = 2) +
    geom_line(data = chl_df_ma, aes(y = chl_ma04), col = 'blue', lwd = 1) +
    geom_line(data = chl_df_ma, aes(y = chl_ma04u), col = 'blue', lty = 2) +
    theme_bw() +
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(5), 
...
```{r, echo = FALSE}
df2020 <- match_aop_sensor(aop_datetimes_df, chl_df_ma)
...
avail_list[[8]]$dataHr %>%
   ...
   geom_errorbar(aes(ymin = fDOM - fDOMExpUncert,
    ...
    geom_line(lwd = 0.25) +
    xlab(element_blank()) +
    geom_point(pch = 21, size = 2, fill = 'blue', alpha = 0.7) +
    theme_bw() +
    coord_cartesian(ylim = c(50, 150)) +
    ggtitle(glue('{mysite} AIS fDOM 12 hours around {avail_list[[8]]$summary$flightline_datetime} UTC'))
...
avail_list[[11]]$data1 %>%
    ...
    ggtitle(glue('{mysite} AIS fDOM 1 day around {lubridate::as_date(avail_list[[11]]$summary$flightline_datetime)}'))
...
avail_list[[11]]$dataHr %>%
   ...
   geom_errorbar(aes(ymin = fDOM - fDOMExpUncert,
    ...
    theme_bw() +
    coord_cartesian(ylim = c(75, 125)) +
    ggtitle(glue('{mysite} AIS fDOM 12 hours around {avail_list[[11]]$summary$flightline_datetime} UTC'))
...
avail_list[[12]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(75, 125)) +
    ggtitle(glue('{mysite} AIS fDOM 1 day around {lubridate::as_date(avail_list[[12]]$summary$flightline_datetime)}'))
...
avail_list[[12]]$dataHr %>%
    ...
    theme_bw() +
        coord_cartesian(ylim = c(75, 125)) +
    ggtitle(glue('{mysite} AIS fDOM 12 hours around {avail_list[[12]]$summary$flightline_datetime} UTC'))
...
avail_list[[13]]$data30 %>%
    ...
    ggtitle(glue('{mysite} AIS fDOM 30 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data10 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(50, 75)) +
    ggtitle(glue('{mysite} AIS fDOM 10 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(50, 75)) +
    ggtitle(glue('{mysite} AIS fDOM 1 day around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[16]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(50, 75)) +
    xlim(c(avail_list[[16]]$summary$flightline_datetime - ddays(1), avail_list[[16]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS fDOM 1 day around {avail_list[[16]]$summary$flightline_datetime} UTC'))
...
avail_list[[17]]$data10 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(50, 75)) +
    xlim(c(avail_list[[17]]$summary$flightline_datetime - ddays(10), avail_list[[17]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS fDOM 10 days around {lubridate::as_date(avail_list[[17]]$summary$flightline_datetime)}'))
...
df2019 <- match_aop_sensor(aop_datetimes_df, fdom_df_ma)
...
rm1 <- fdom_df_tsibble %>%
  ggplot(aes(x = datetime, y = fdom5min)) +
  xlab(element_blank()) +
  geom_point(pch = 21, fill = 'blue', alpha = 0.25, size = 2) +
  geom_line(data = fdom_df_ma, aes(y = ma03), col = 'red', lwd = 1) +
  theme_bw() +
  geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
...
rm2 <- fdom_df_tsibble %>%
  ...
  xlab(element_blank()) +
  geom_point(pch = 21, fill = 'blue', alpha = 0.25, size = 2) +
  geom_line(data = fdom_df_ma, aes(y = ma04), col = 'orange', lwd = 1) +
  theme_bw() +
     geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
  xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(5), 
...
df2020 <- match_aop_sensor(aop_datetimes_df, fdom_df_ma)
...
absSUNA_df <- fs::dir_ls(proc_dir, glob = '*2019*') %>% vroom::vroom()
```
...
df2019 <- match_aop_sensor(aop_datetimes_df, abs_df_ma)

df2019 %>% dplyr::select(c(1:3,5:10)) %>% knitr::kable(digits = 4)
df2019 %>% dplyr::select(c(1,2,4,11:16)) %>% knitr::kable(digits = 4)
```

### 2020 abs plots
```{r, echo = FALSE}
proc_dir <- glue::glue('~/Box/data/NEON-processed/suna-L0-timeseries/{mysite}/AOP-dates')
absSUNA_df <- fs::dir_ls(proc_dir, glob = '*2020*') %>% vroom::vroom()
```
...
df2020 <- match_aop_sensor(aop_datetimes_df, abs_df_ma)

df2020 %>% dplyr::select(c(1:3,5:10)) %>% knitr::kable(digits = 4)
df2020 %>% dplyr::select(c(1,2,4,11:16)) %>% knitr::kable(digits = 4)
```
...
avail_list[[8]]$data10 %>%
    ...
    # geom_line() +
    xlab(element_blank()) +
    geom_point(pch = 21, size = 1, fill = 'orange', alpha = 0.7) +
    theme_bw() +
     xlim(c(avail_list[[8]]$summary$flightline_datetime - ddays(10),
            avail_list[[8]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS nitrate 10 days around {lubridate::as_date(avail_list[[8]]$summary$flightline_datetime)}'))
...
avail_list[[8]]$data1 %>%
   dplyr::filter(finalQF == 0) %>%
    ...
    geom_line() +
    xlab(element_blank()) +
    geom_point(pch = 21, size = 2, fill = 'orange', alpha = 0.7) +
    theme_bw() +
     xlim(c(avail_list[[8]]$summary$flightline_datetime - ddays(1),
            avail_list[[8]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {lubridate::as_date(avail_list[[8]]$summary$flightline_datetime)}'))
...
avail_list[[11]]$data1 %>%
    ...
    geom_point(pch = 21, size = 2, fill = 'orange', alpha = 0.7) +
    theme_bw() +
     xlim(c(avail_list[[11]]$summary$flightline_datetime - ddays(1),
            avail_list[[11]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {lubridate::as_date(avail_list[[11]]$summary$flightline_datetime)}'))
...
avail_list[[12]]$data1 %>%
    ...
    geom_point(pch = 21, size = 2, fill = 'orange', alpha = 0.7) +
    theme_bw() +
     xlim(c(avail_list[[12]]$summary$flightline_datetime - ddays(1),
            avail_list[[12]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {lubridate::as_date(avail_list[[12]]$summary$flightline_datetime)}'))
...
```{r sunaplots2020, echo = FALSE, eval = FALSE}
###### 2020 #######
...
avail_list[[13]]$data30 %>%
 dplyr::filter(finalQF == 0) %>%
    ...
    geom_point(pch = 21, size = 1, fill = 'orange', alpha = 0.1) +
    theme_bw() +
     xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(30),
            avail_list[[13]]$summary$flightline_datetime + ddays(30))) +
    ggtitle(glue('{mysite} AIS nitrate 30 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data10 %>%
  dplyr::filter(finalQF == 0) %>%
    ...
    geom_point(pch = 21, size = 1, fill = 'orange', alpha = 0.7) +
    theme_bw() +
     xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(10),
            avail_list[[13]]$summary$flightline_datetime + ddays(10))) +
    coord_cartesian(ylim = c(20, 40)) +
    ggtitle(glue('{mysite} AIS nitrate 10 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data1 %>%
   dplyr::filter(finalQF == 0) %>%
    ...
    theme_bw() +
      coord_cartesian(ylim = c(20, 40)) +
     xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(1),
            avail_list[[13]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[16]]$data1 %>%
  dplyr::filter(finalQF == 0) %>%
    ...
    theme_bw() +
      coord_cartesian(ylim = c(20, 40)) +
     xlim(c(avail_list[[16]]$summary$flightline_datetime - ddays(1),
            avail_list[[16]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {avail_list[[16]]$summary$flightline_datetime} UTC'))
...
avail_list[[17]]$data10 %>%
    ...
    theme_bw() +
      coord_cartesian(ylim = c(20, 40)) +
     xlim(c(avail_list[[17]]$summary$flightline_datetime - ddays(10),
            avail_list[[17]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS nitrate 10 days around {lubridate::as_date(avail_list[[17]]$summary$flightline_datetime)}'))
...
avail_list[[8]]$dataHr %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 8)) +
    ggtitle(glue('{mysite} AIS turbidity 12 hours around {avail_list[[8]]$summary$flightline_datetime} UTC'))
...
avail_list[[11]]$data1 %>%
   ...
   ggplot(aes(x = startDateTime, y = turbidity)) +
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 8)) +
    ggtitle(glue('{mysite} AIS turbidity 1 day around {lubridate::as_date(avail_list[[11]]$summary$flightline_datetime)}'))
...
avail_list[[11]]$dataHr %>%
   ...
   ggplot(aes(x = startDateTime, y = turbidity)) +
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 8)) +
    ggtitle(glue('{mysite} AIS turbidity 12 hours around {avail_list[[11]]$summary$flightline_datetime} UTC'))
...
avail_list[[12]]$data1 %>%
   ...
   ggplot(aes(x = startDateTime, y = turbidity)) +
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 8)) +
    ggtitle(glue('{mysite} AIS turbidity 1 day around {lubridate::as_date(avail_list[[12]]$summary$flightline_datetime)}'))
...
avail_list[[12]]$dataHr %>%
   ...
   ggplot(aes(x = startDateTime, y = turbidity)) +
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 8)) +
    ggtitle(glue('{mysite} AIS turbidity 12 hours around {avail_list[[12]]$summary$flightline_datetime} UTC'))
...
avail_list[[13]]$data30 %>%
    ...
    xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(30), 
             avail_list[[13]]$summary$flightline_datetime + ddays(30))) +
    ggtitle(glue('{mysite} AIS turbidity 30 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data10 %>%
    ...
    xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(10), 
             avail_list[[13]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS turbidity 10 days around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[13]]$data1 %>%
    ...
    coord_cartesian(ylim = c(0, 10)) +
      xlim(c(avail_list[[13]]$summary$flightline_datetime - ddays(1), 
             avail_list[[13]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS turbidity 1 day around {lubridate::as_date(avail_list[[13]]$summary$flightline_datetime)}'))
...
avail_list[[16]]$data1 %>%
    ...
    coord_cartesian(ylim = c(0, 10)) +
    xlim(c(avail_list[[16]]$summary$flightline_datetime - ddays(1), avail_list[[16]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS turbidity 1 day around {avail_list[[16]]$summary$flightline_datetime} UTC'))
...
avail_list[[17]]$data10 %>%
    ...
    coord_cartesian(ylim = c(0, 10)) +
    xlim(c(avail_list[[17]]$summary$flightline_datetime - ddays(10), avail_list[[17]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS turbidity 10 days around {lubridate::as_date(avail_list[[17]]$summary$flightline_datetime)}'))
...
df2019 <- match_aop_sensor(aop_datetimes_df, turb_df_ma)
...
df2020 <- match_aop_sensor(aop_datetimes_df, turb_df_ma)
