...
* See [here](https://khondula.github.io/spectra-models/03_PRPO-AOP.html) for AOP spectra from PRLA buoy location
...
# Summary of data overlap for PRPO

* Green flightlines from 1 day in 2019 (July 30) and 2 from same day in 2020 (June 24). Similar shape but higher in 2019 than 2020. Chl a much higher in 2019 than 2020.
* In **2019**, chl sampling from July 15 (2 weeks before), chemistry August 6 (7 days after), and sensor data is available. fDOM looks really weird (very low/negative during flight time). SUNA step change much higher on day of flight, high turbidity on day of flight
* In **2020**, chl sampling from June 22 (2 days before), chemistry data from either June 9 (15 days before), June 30, or August 4 depending on analyte. sensor data available, negative values for chl sensor (QF issues). fdom large uncertainty but more normal looking values than 2019. No TSS data within 200 days
* AOP data also collected in 2016 (yellow) and 2017 (1 green, 1 red)
...
avail_list[[5]]$data30 %>%
    ...
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 30 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data10 %>%
    ...
    geom_point(pch = 21, size = 1, fill = 'green', alpha = 0.1) +
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 10 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data1 %>%
    ...
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 1 day around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$dataHr %>%
    ...
    geom_point(pch = 21, size = 2, fill = 'green') +
    theme_bw() +
    ggtitle(glue('{mysite} AIS cholorophyll 12 hours around {avail_list[[5]]$summary$flightline_datetime} UTC'))
...
avail_list[[6]]$data30 %>%
  ...
  coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 30 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data10 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 10 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(NA, 25)) +
    ggtitle(glue('{mysite} AIS cholorophyll 1 day around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
df <- avail_list[[5]]$data10 %>%dplyr::filter(chlorophyllFinalQF == 0) 
...
rm1 <- chl_df_tsibble %>%
  ...
  geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
  xlim(c(avail_list[[5]]$summary$flightline_datetime - ddays(5), 
         avail_list[[5]]$summary$flightline_datetime + ddays(5))) +
...
rm1 <- chl_df_tsibble %>%
    ...
    geom_vline(data = aop_datetimes_df, 
               aes(xintercept = collectDateTime), col = 'purple') +
    xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(5), 
           avail_list[[6]]$summary$flightline_datetime + ddays(5))) +
    coord_cartesian(ylim = c(NA, 40)) +
    ggtitle(glue('Rolling mean 3 hours'))
  rm2 <- chl_df_tsibble %>%
    ggplot(aes(x = datetime, y = chl5min)) +
...
```{r}
chl_ais_tosave <- bind_rows(df2019, df2020) %>% 
...
avail_list[[5]]$data30 %>%
    ...
    ggtitle(glue('{mysite} AIS fDOM 30 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data10 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 200)) +
    ggtitle(glue('{mysite} AIS fDOM 10 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 200)) +
    ggtitle(glue('{mysite} AIS fDOM 1 day around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$dataHr %>%
   ...
   geom_errorbar(aes(ymin = fDOM - fDOMExpUncert,
    ...
    ggtitle(glue('{mysite} AIS fDOM 12 hours around {avail_list[[5]]$summary$flightline_datetime} UTC'))
...
avail_list[[6]]$data30 %>%
    ...
    ggtitle(glue('{mysite} AIS fDOM 30 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data10 %>%
    ...
    ggtitle(glue('{mysite} AIS fDOM 10 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data1 %>%
    ...
    theme_bw() +
    coord_cartesian(ylim = c(0, 120)) +
    ggtitle(glue('{mysite} AIS fDOM 1 day around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
# df <- avail_list[[5]]$data10 %>% dplyr::filter(fDOMFinalQF == 0) 
df <- avail_list[[5]]$data10
...
```{r}
fdom_ais_tosave <- bind_rows(df2019, df2020) %>% 
  dplyr::rename(aop_datetime = collectDateTime, sensor_rollavg_datetime = datetime) %>%
  dplyr::mutate(siteID = mysite) %>%
  dplyr::select(siteID, 1:9) %>%
  dplyr::left_join(mysite_rad_df2, by = c('aop_datetime' = 'datetime_utc'))
...
```{r}
suna_ais_tosave <- bind_rows(df2019, df2020) %>% 
  dplyr::rename(aop_datetime = collectDateTime, sensor_rollavg_datetime = datetime) %>%
  dplyr::mutate(siteID = mysite) %>%
...
avail_list[[5]]$data30 %>% 
    ...
    theme_bw() +
     xlim(c(avail_list[[5]]$summary$flightline_datetime - ddays(30),
            avail_list[[5]]$summary$flightline_datetime + ddays(30))) +
    ggtitle(glue('{mysite} AIS nitrate 30 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data10 %>%
    ...
    theme_bw() +
     xlim(c(avail_list[[5]]$summary$flightline_datetime - ddays(10),
            avail_list[[5]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS nitrate 10 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data1 %>%
   dplyr::filter(finalQF == 0) %>%
    ...
    theme_bw() +
     xlim(c(avail_list[[5]]$summary$flightline_datetime - ddays(1),
            avail_list[[5]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data30 %>%
 dplyr::filter(finalQF == 0) %>%
    ...
    geom_point(pch = 21, size = 1, fill = 'orange', alpha = 0.1) +
    theme_bw() +
     xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(30),
            avail_list[[6]]$summary$flightline_datetime + ddays(30))) +
    ggtitle(glue('{mysite} AIS nitrate 30 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data10 %>%
  dplyr::filter(finalQF == 0) %>%
    ...
    geom_point(pch = 21, size = 1, fill = 'orange', alpha = 0.7) +
    theme_bw() +
     xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(10),
            avail_list[[6]]$summary$flightline_datetime + ddays(10))) +
    coord_cartesian(ylim = c(20, 35)) +
    ggtitle(glue('{mysite} AIS nitrate 10 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data1 %>%
   dplyr::filter(finalQF == 0) %>%
    ...
    coord_cartesian(ylim = c(25, 35)) +
     xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(1),
            avail_list[[6]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS nitrate 1 day around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data30 %>%
    ...
    theme_bw() +
    ggtitle(glue('{mysite} AIS turbidity 30 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data10 %>%
   dplyr::filter(turbidityFinalQF == 0) %>%
    ...
    geom_point(pch = 21, size = 1, fill = 'red', alpha = 0.1) +
    theme_bw() +
    ggtitle(glue('{mysite} AIS turbidity 10 days around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$data1 %>%
    ...
    ggtitle(glue('{mysite} AIS turbidity 1 day around {lubridate::as_date(avail_list[[5]]$summary$flightline_datetime)}'))
...
avail_list[[5]]$dataHr %>%
    ...
    theme_bw() +
    # coord_cartesian(ylim = c(0, 8)) +
    ggtitle(glue('{mysite} AIS turbidity 12 hours around {avail_list[[5]]$summary$flightline_datetime} UTC'))
...
avail_list[[6]]$data30 %>%
    ...
    xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(30), 
             avail_list[[6]]$summary$flightline_datetime + ddays(30))) +
    ggtitle(glue('{mysite} AIS turbidity 30 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data10 %>%
    ...
    xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(10), 
             avail_list[[6]]$summary$flightline_datetime + ddays(10))) +
    ggtitle(glue('{mysite} AIS turbidity 10 days around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
avail_list[[6]]$data1 %>%
    ...
    coord_cartesian(ylim = c(0, 100)) +
      xlim(c(avail_list[[6]]$summary$flightline_datetime - ddays(1), 
             avail_list[[6]]$summary$flightline_datetime + ddays(1))) +
    ggtitle(glue('{mysite} AIS turbidity 1 day around {lubridate::as_date(avail_list[[6]]$summary$flightline_datetime)}'))
...
df <- avail_list[[5]]$data10 %>% dplyr::filter(turbidityFinalQF == 0)
...
```{r}
turb_ais_tosave <- bind_rows(df2019, df2020) %>% 
  dplyr::rename(aop_datetime = collectDateTime, sensor_rollavg_datetime = datetime) %>%
  dplyr::mutate(siteID = mysite) %>%
  dplyr::select(siteID, 1:9) %>%
  dplyr::left_join(mysite_rad_df2, by = c('aop_datetime' = 'datetime_utc'))
